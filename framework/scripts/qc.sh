...
export API_HOST="http://api.yangbentong.priv"
...
export PUBLIC_PATH="http://assets-cdn.yangben.priv/v3-framework/${VERSION}"
export PACKAGE_BUNDLE_PREFIX="http://assets-cdn.yangben.priv/v3-modules/official"
